    ...
    try {
      ...
      for (const task of tasks) {
        ...
        newResults.push({
          ...
          qbo_class: qboCleaningLine?.item_class || qboPetLine?.item_class || listing?.qbo_class_name || '',
        ...
        if (qboPetLine) {
          newResults.push({
            ...
            listing_id: listing?.id || '',
            listing_name: task.listing_name || listing?.listing_name || '',
            qbo_class: qboPetLine?.item_class || qboCleaningLine?.item_class || listing?.qbo_class_name || '',
            guest_name: reservation?.guest_name || '',
            check_in_date: reservation?.check_in_date || '',
            checkout_date: reservation?.check_out_date || '',
            reservation_created_date: reservation?.reservation_created_date || '',
      ...
      for (const [key, lines] of Object.entries(qboByKey)) {
        ...
        for (const qboLine of lines) {
          ...
          newResults.push({
            ...
            listing_name: qboLine.listing_name || qboLine.item_class || qboLine.qbo_class || '',
            qbo_class: qboLine.item_class || qboLine.qbo_class || '',
